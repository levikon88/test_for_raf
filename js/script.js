function makeResult(e) {
	...
	if (resultText.length === initSize) {
		resultText = `<p>К сожалению, Вам не подходит ни одна из представленных моделей. Так как смешанное обучение представляет собой сочетание 
		очного и онлайн-компонентов, крайне важно обратить внимание на материально-техническое обеспечение образовательного процесса. Так, 
			например, для того, чтобы для Вас стала доступна хотя бы одна из моделей, обязательным условием является один из следующих  факторов:</p>
			<p>наличие у обучающихся личных устройств с выходом в Интернет;</p>
			<p>наличие персональных устройств для 1/3 группы;</p>
